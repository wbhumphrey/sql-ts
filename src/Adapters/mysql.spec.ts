...
describe('mysql', () => {
  ...
  describe('getAllColumns', () => {
    it('should get all columns', async (done) => {
      ...
      const mockSelectExtra = jasmine.createSpy('select').and.returnValue({ where: mockWhere })
      const mockSelectType = jasmine.createSpy('select').and.returnValue({ select: mockSelectExtra })
